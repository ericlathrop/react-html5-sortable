...
var MyListItem = React.createClass({displayName: "MyListItem",
	mixins: [Sortable],
	render: function() {
		return React.createElement("div", {className: "my-list-item"}, this.props.text);
	}
});
...
var MyList = React.createClass({displayName: "MyList",
	render: function() {
		var items = this.props.items.map(function(item) {
			return React.createElement(MyListItem, {key: item, reactKey: item, text: item, onMove: this.props.onMove});
		}.bind(this));
		return React.createElement("div", {className: "my-list"}, items);
	}
});

var MyDragHandleListItem = React.createClass({displayName: "MyDragHandleListItem",
	mixins: [Sortable],
	render: function() {
		return (
			React.createElement("div", {className: "my-list-item"}, 
				React.createElement("span", {className: "drag-handle", ref: "dragHandle"}, "[handle]"), 
				this.props.text
			)
		);
	}
...
var MyDragHandleList = React.createClass({displayName: "MyDragHandleList",
	render: function() {
		var items = this.props.items.map(function(item) {
			return React.createElement(MyDragHandleListItem, {key: item, reactKey: item, text: item, onMove: this.props.onMove});
		}.bind(this));
		return React.createElement("div", {className: "my-list"}, items);
	}
});
...
function render() {
	React.render(React.createElement(MyList, {items: items, onMove: move.bind(this, items)}), document.getElementById("list-demo"));
	React.render(React.createElement(MyDragHandleList, {items: items, onMove: move.bind(this, items)}), document.getElementById("drag-handle-demo"));
}
